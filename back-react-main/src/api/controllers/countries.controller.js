...
const putCountry = async (req, res) => {
    try {
        ...
        putCountries._id = id;
        const updateCountries = await Country.findByIdAndUpdate(id, putCountries, {new: true});
        if(!updateCountries){
...
module.exports = {getCountries, getOneCountry, postCountry, putCountry, deleteCountry}